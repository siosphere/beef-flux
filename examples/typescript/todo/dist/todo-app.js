...
;
exports.TodoActions = beef.Actions.create(new TodoActionsClass());
...
var TodoStoreClass = (function (_super) {
    ...
    function TodoStoreClass() {
        _super.call(this);
        TodoActions_1.TodoActions._register({
            receiveTodos: TodoActions_1.TodoActions.receiveTodos
        }, this);
    }
    ...
    TodoStoreClass.prototype.receiveTodos = function (rawTodos) {
        ...
        rawTodos.forEach(function (rawTodo) {
            var todo = _this.sanitize(rawTodo, Todo_1.Todo.schema);
            _this.upsertRow('todo', 'id', new Todo_1.Todo(todo));
        });
...
var AppContainer = (function () {
    function AppContainer() {
        TodoStore_1.TodoStore.listen('TodoStore.event.UPDATE', this.onUpdate);
    }
    AppContainer.prototype.createTodo = function () {
        TodoActions_1.TodoActions.receiveTodos([{
                name: 'My New Todo'
            }]);
    };
    ...
    AppContainer.prototype.onUpdate = function () {
        console.log(TodoStore_1.TodoStore.getTodos());
        TodoApi_1.TodoApi.saveTodo(TodoStore_1.TodoStore.getTodos()[TodoStore_1.TodoStore.getTodos().length - 1]);
    };
    return AppContainer;
}());
...
},{"../actions/actions":undefined,"../actions/component/action":undefined,"../api/api-service":undefined,"../routing/component/config":undefined,"../routing/decorators/route-decorator":undefined,"../routing/routing-service":undefined,"../store/store":undefined,"../store/store-decorator":undefined,"./component/action":undefined,"./component/config":undefined,"./store":undefined,"extend":8,"reqwest":9,"xhr2":undefined}],7:[function(require,module,exports){
